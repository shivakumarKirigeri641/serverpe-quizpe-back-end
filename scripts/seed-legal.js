...
const DOCS = [
...

  {
    ...
    sections: [
      ...
      ['9', 'First-plan welcome offer (bonus days and a tree)',
        'As a one-time welcome, your FIRST paid plan on a mobile number (any tier) receives 7 bonus days added to that plan, and we plant a tree in your child\'s name. The 7 bonus days are applied immediately at payment. The tree is a goodwill gesture with no cash value and cannot be exchanged for a refund, discount or extension. Planting is carried out in batches, so obtaining the plantation and uploading the proof video to our YouTube channel may take some time; a delay in the video does not affect your plan or your bonus days. This offer applies once per mobile number, only on the first paid plan (not on renewals or the free trial), and we may vary or withdraw it for future customers at any time.'],
    ],
  },
